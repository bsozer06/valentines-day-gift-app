// ==================== VERİLER ====================
// DEĞİŞTİR: Kendi verilerinizi buraya ekleyin

const DATA = {
    // Timeline - İlişkinizdeki önemli anlar
    ...
    // DEĞİŞTİR: Kendi nedenlerinizi ve emojileri ekleyin
     reasons: [
        ...
        },
        {
            icon: "🌟",
            title: "Işığın",
            text: "En karanlık günlerimde bile benim ışığım oldun."
        },
        {
            icon: "❤️",
            title: "Kalbin",
...
Bu satırları yazarken yüreğim sevinçle atıyor. Seninle geçirdiğim her an, hayatıma anlam katan birer hazine.
...
Bugün ve her gün, sana olan sevgimi kutlamak istiyorum. Sen benim her şeyimsin.
